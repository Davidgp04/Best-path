...
tiempo2=time.time()
print(f'Ejecución camino 1 : {round((tiempo2-tiempo1),2)}')
...
tiempo3=time.time()
print(f'Ejecución camino 2 : {round((tiempo3-tiempo1),2)}')
...
tiempo4=time.time()
print(f'Ejecución camino 3 : {round((tiempo4 - tiempo1), 2)}')
print('Ya puedes revisar el mapa :)')
try:
    my_map3.save(r"C:\Users\PC\OneDrive - Universidad EAFIT\Semestre 2\Algoritmos\Proyecto\Código\map1.html")
except:
    print("Modifica la ruta de my_map3 por alguna otra creada")
